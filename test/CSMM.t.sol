...
contract CSMMTest is Test, Deployers {
    ...
    function test_cannotModifiyLiquidity() public{ 
        vm.expectRevert();
        modifyLiquidityRouter.ModifyLiquidityParams(
            key,
    ...
    function test_swap_exactInput_zeroForOne() public {
        ...
        // Swap exact input 100 Token A for 100 Token B 
        uint256 token0BalanceBefore = key.currency0.balanceOfSelf();
        uint256 token1BalanceBefore = key.currency1.balanceOfSelf();
