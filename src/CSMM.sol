...
contract CSMM is BaseHook{
    ...
    // For passing in the callBack function called by the PM when we add the liquidty
    struct CallbackData {
    ...
    // Every time we call any PoolManager function it will call the Callback function in the entity that calls the function 
    // Whether it is the router or the beforeSwap Hook
    ...
    // Function to skip the default swap logic
